...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : ENCODER_1_A_Pin ENCODER_1_B_Pin ENCODER_2_A_Pin ENCODER_2_B_Pin
                           DPAD_UP_Pin DPAD_DOWN_Pin DPAD_RIGHT_Pin DPAD_LEFT_Pin
                           ENCODER_3_A_Pin ENCODER_3_B_Pin ENCODER_4_A_Pin ENCODER_4_B_Pin
                           ENCODER_5_A_Pin ENCODER_5_B_Pin */
  GPIO_InitStruct.Pin = ENCODER_1_A_Pin|ENCODER_1_B_Pin|ENCODER_2_A_Pin|ENCODER_2_B_Pin
                          |DPAD_UP_Pin|DPAD_DOWN_Pin|DPAD_RIGHT_Pin|DPAD_LEFT_Pin
                          |ENCODER_3_A_Pin|ENCODER_3_B_Pin|ENCODER_4_A_Pin|ENCODER_4_B_Pin
                          |ENCODER_5_A_Pin|ENCODER_5_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
